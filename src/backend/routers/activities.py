...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced').
      Use 'unspecified' to show only activities with no difficulty set (open to all levels).
    """
    ...
    if difficulty:
        if difficulty.lower() == "unspecified":
            # "unspecified" means activities open to all levels (no difficulty field set)
